...
namespace StargateAPI.Business.Commands
{
    ...
    public class CreateAstronautDutyPreProcessor : IRequestPreProcessor<CreateAstronautDuty>
    {
        ...
        public Task Process(CreateAstronautDuty request, CancellationToken cancellationToken)
        {
            ...
            if (person is null) throw new ObjectNotFoundException($"Bad Request. Person {request.Name} was not found.");

            var verifyNoPreviousDuty = _context.AstronautDuties.FirstOrDefault(z => z.DutyTitle == request.DutyTitle && z.DutyStartDate == request.DutyStartDate); //Better way to determine prev duties?
    ...
    public class CreateAstronautDutyHandler : IRequestHandler<CreateAstronautDuty, CreateAstronautDutyResult>
    {
        ...
        public async Task<CreateAstronautDutyResult> Handle(CreateAstronautDuty request, CancellationToken cancellationToken)
        {
            ...
            if (person is null) throw new ObjectNotFoundException($"Person by the name {request.Name} does not exist.");
            ...
            if (astronautDetail == null)
            {
                ...
                {
                    astronautDetail.CareerEndDate = request.DutyStartDate;
                }
            ...
            {
                astronautDetail.CurrentDutyTitle = request.DutyTitle.ToUpper();
                astronautDetail.CurrentRank = request.Rank;
                if (String.Equals(request.DutyTitle, "RETIRED", StringComparison.OrdinalIgnoreCase))
                {
            ...
            {
                if (astronautDuty.DutyStartDate > request.DutyStartDate) throw new InvalidOperationException("New duty's start date cannot be before previous duties start date.");
            ...
            _logger.LogInformation($"Success Creating new astronaut duty for {request.Name}");
